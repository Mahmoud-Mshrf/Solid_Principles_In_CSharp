...
{
    // in this example, the Account class has two responsibilities
    // 1- Manage the account balance
    // 2- Send an email to the account holder
    // MakeTransaction method can be extracted to a separated methods to handle deposit and withdraw
    // and the email sending can be extracted to a separated class
